# Prompt: Time series
# Seasons -- monthly births heatmap, 2003-2024 (IBGE Civil Registry)
...
import::from(readr, parse_date, locale)
import::from(lubridate, month)
import::from(forcats, fct_reorder, fct_rev)
...
ggsave(
  here("2026", "plots", "23_seasons.png"),
  plot_final,
  width = 8,
  height = 5,
  dpi = 400
...
# Per-region heatmap variant, superseded by the Brazil-only final chart.
...
#     ) +
#     labs(
#       title = str_glue("Monthly births: {name_region}"),
#       subtitle = NULL,
#       x = NULL,
#       y = NULL,
#       fill = "Share of annual births (%)"
...
# Deseasonalized regression check on the monthly effect.
# xreg <- tab_births |>
#   mutate(
